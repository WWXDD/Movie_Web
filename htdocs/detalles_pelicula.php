...
<main>
    ...
    if (isset($_GET['id'])) {
        ...
        echo '<tr><td colspan="2" style="text-align: center;"><img src="/php_program/Project/images/' . htmlspecialchars($pelicula['url_pic']) . '" style="width: 400px; height: 600px;"></td></tr>';
