...
<header>
    <h1>Catálogo de Películas</h1>
        ...
        if ($row = $result->fetch_assoc()) {
            ...
            echo '<img src="/php_program/Project/images/' . htmlspecialchars($profile_pic) . '" alt="Profile Image" style="width: 50px; height: 50px;">';
        }
        $stmt->close();
        $conn->close();
        ...
        <div class="catalogo">
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <img src="/php_program/Project/images/' . htmlspecialchars($row['url_pic']) . '" width="500" height="250">
                    </a>
                    </td>'; 
